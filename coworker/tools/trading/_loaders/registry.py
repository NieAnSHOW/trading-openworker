...
from coworker.tools.trading._loaders.base import NoAvailableSourceError
...
FALLBACK_CHAINS: dict[str, list[str]] = {
    "a_share":   ["tencent", "mootdx", "eastmoney", "baostock", "a_stock_data", "akshare", "tushare", "local"],
