...
本 skill 为 OpenWorker 内置副本，vendored from [HiThink-Tech/Financial-API](https://github.com/HiThink-Tech/Financial-API) @ `765513c`（MIT）。`SKILL.md` 与 `references/` 与上游保持一致，更新时整目录替换。

在 OpenWorker 环境中，上述流程按以下方式落地：
