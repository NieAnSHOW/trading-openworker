...
from coworker.factors.compare_runner import SORT_KEYS as _COMPARE_SORT_KEYS, compare_alphas
from coworker.factors.registry import Registry, RegistryError
...
def cmd_alpha_bench(args: argparse.Namespace) -> int:
    ...
    try:
        try:
            from coworker.factors.bench_runner import run_bench
        ...
        try:
            from coworker.tools.trading.alpha_bench_tool import (  # type: ignore[import-not-found]
                _CSP,
                _REPORT_CSS,
                _default_output_dir,
                _render_html,
